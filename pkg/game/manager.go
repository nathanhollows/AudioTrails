...
func init() {
	...
	clues = append(clues, Clue{"B0Y2H", "Castle Lecture Theatres", "Though you may not find any knights here, this Castle is still home to things that should be feared…", false})
